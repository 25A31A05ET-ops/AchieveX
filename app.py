...
project_upload_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), "uploads")
try:
    os.makedirs(project_upload_folder, exist_ok=True)
    upload_folder = project_upload_folder
except OSError:
    upload_folder = os.path.join(tempfile.gettempdir(), "achievex-uploads")
    try:
